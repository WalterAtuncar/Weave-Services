...
{
    public class AprobarViaEmailHandler : IRequestHandler<AprobarViaEmailCommand, EmailActionResultDto>
    {
        ...
        public async Task<EmailActionResultDto> Handle(AprobarViaEmailCommand request, CancellationToken cancellationToken)
        {
            ...
            if (!string.Equals(token.TipoAccion, "APROBAR", StringComparison.OrdinalIgnoreCase))
            {
            ...
            token.ResultadoAccion = "APROBADO";
