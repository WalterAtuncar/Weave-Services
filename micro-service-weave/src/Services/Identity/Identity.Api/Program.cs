...
// Registro de handlers personalizados (Features locales)
builder.Services.AddMediatR(cfg => cfg.RegisterServicesFromAssembly(Assembly.GetExecutingAssembly()));

// Middleware externo (lib.on.middleware)
builder.Services.AddWinMiddleware("micro-service-weave.Identity.API", builder.Environment.IsDevelopment());
...
// Escaneo de tipos con TableAttribute en Identity.Domain
