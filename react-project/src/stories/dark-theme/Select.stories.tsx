          ...
          <section style={{ 
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <h3 style={{ fontSize: '14px', fontWeight: '500', color: '#94A3B8' }}>Select Básico</h3>
              ...
              {/* Select con Label */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <h3 style={{ fontSize: '14px', fontWeight: '500', color: '#94A3B8' }}>Con Label</h3>
                <SelectWrapper
              ...
              {/* Select Requerido */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <h3 style={{ fontSize: '14px', fontWeight: '500', color: '#94A3B8' }}>Campo Requerido</h3>
                <SelectWrapper
                  label="Prioridad"
                  icon="AlertTriangle"
                  requiredText={true}
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <h3 style={{ fontSize: '14px', fontWeight: '500', color: '#94A3B8' }}>Deshabilitado</h3>
                <SelectWrapper
              ...
              {/* Select con Grupos */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                <h3 style={{ fontSize: '14px', fontWeight: '500', color: '#94A3B8' }}>Con Grupos</h3>
                <SelectWrapper
...
const meta: Meta<typeof DarkThemeApp> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "Componente Select con múltiples variantes para formularios del sistema de gestión de procesos en tema oscuro. Incluye validación, iconos, grupos y estados."
      }
    }
  },
};
...
export const AllVariants: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Muestra todas las variantes del componente Select: básico, con label, con icono, requerido, deshabilitado, con grupos y ejemplo de formulario completo en tema oscuro."
      }
    }
  }
}; 