...
const AlertDemo = () => {
  ...
  const handleError = () => {
    AlertService.error('Ha ocurrido un error inesperado. Por favor, inténtalo de nuevo.', {
      title: 'Error',
      duration: 5000
    });
  };
    ...
    <div style={{ 
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        <h1 style={{ 
          ...
          Sistema de Alertas - Tema Oscuro
        </h1>
...
const meta: Meta<typeof AlertDemo> = {
  title: 'Dark Theme/Alerts',
  component: AlertDemo,
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        component: 'Sistema completo de alertas con React Hot Toast + Headless UI para tema oscuro. Incluye todos los tipos de alertas con diseño moderno y profesional.'
      }
    }
  },
  decorators: [
