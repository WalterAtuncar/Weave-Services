  ...
  return (
    <ThemeProvider>
      <div style={{ minHeight: '100vh', padding: 24, background: '#F5F7FA' }}>
        <h1 style={{ fontSize: 28, fontWeight: 700, textAlign: 'center', color: '#414976', marginBottom: 24 }}>Menu Cards – Light</h1>
        <MenuGrid preset="3x3">
          <MenuCard
            title="Crear Proceso"
...
const meta: Meta<typeof LightThemeMenuShowcase> = {
  title: "Light Theme/MenuCard",
  component: LightThemeMenuShowcase,
  parameters: {
    layout: "fullscreen",
    docs: {
      description: {
        component: "Menú de tarjetas para el tema claro, con soporte para acciones internas y click del card."
      }
    }
  }
};
...
// Nueva historia: MenuCard con acciones que abren SelectorItemsModal
...
const LightMenuWithSelector = () => {
  ...
  return (
    <ThemeProvider>
      <AlertProvider>
        <div style={{ minHeight: '100vh', padding: 24, background: '#F5F7FA' }}>
          <h1 style={{ fontSize: 24, fontWeight: 700, textAlign: 'center', color: '#414976', marginBottom: 16 }}>Acciones con Selector</h1>
          <MenuGrid preset="3x3">
...
export const ConSelectorItemsModal: Story = {
  name: 'MenuCard – Selector Actions',
  render: () => <LightMenuWithSelector />,
};