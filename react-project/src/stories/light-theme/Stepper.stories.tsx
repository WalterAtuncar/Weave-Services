...
const meta: Meta<typeof Stepper> = {
  title: 'Light Theme/Stepper',
  component: Stepper,
  parameters: {
    layout: 'centered',
    docs: {
      description: {
        component: 'Componente Stepper modal horizontal para procesos de múltiples pasos con navegación y validación.',
      },
    },
  },
  decorators: [
...
// Story principal para Light Theme
            ...
            <div style={{ display: 'grid', gap: '2rem' }}>
              <div>
                ...
                <div style={{ 
                  ...
                  <p><strong style={{ color: '#111827' }}>Nombres:</strong> {personaData.nombres}</p>
                  <p><strong style={{ color: '#111827' }}>Email:</strong> {personaData.emailPersonal}</p>
                </div>
              </div>
              <div>
                <h3 style={{ margin: '0 0 1rem 0', color: '#111827', fontWeight: '600' }}>
                ...
                <div style={{ 
                  ...
                  <p><strong style={{ color: '#1e40af' }}>Usuario:</strong> {usuarioData.nombreUsuario}</p>
                  <p><strong style={{ color: '#1e40af' }}>Contraseña:</strong> {'*'.repeat(usuarioData.hashPassword.length)}</p>
                </div>
              </div>
            </div>
          );
